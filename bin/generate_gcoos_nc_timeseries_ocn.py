...
obs1                        = nc.createVariable('sea_water_speed','d',('time','timeSeries'),fill_value=-999.)
...
obs2                        = nc.createVariable('direction_of_sea_water_velocity','d',('time','timeSeries'),fill_value=-999.)
...
obs3                        = nc.createVariable('upward_sea_water_velocity','d',('time','timeSeries'),fill_value=-999.)
...
obs4                        = nc.createVariable('eastward_sea_water_velocity','d',('time','timeSeries'),fill_value=-999.)
...
obs5                        = nc.createVariable('northward_sea_water_velocity','d',('time','timeSeries'),fill_value=-999.)
...
obs6                        = nc.createVariable('mass_concentration_of_chlorophyll_in_sea_water','d',('time','timeSeries'),fill_value=-999.)
...
obs7                        = nc.createVariable('mole_concentration_of_dissolved_oxygen_in_sea_water','d',('time','timeSeries'),fill_value=-999.)
...
obs8                        = nc.createVariable('sea_surface_height_above_sea_level','d',('time','timeSeries'),fill_value=-999.)
...
obs9                        = nc.createVariable('sea_water_practical_salinity','d',('time','timeSeries'),fill_value=-999.)
...
obs10                        = nc.createVariable('sea_water_temperature','d',('time','timeSeries'),fill_value=-999.)
...
obs11                        = nc.createVariable('sea_water_turbidity','d',('time','timeSeries'),fill_value=-999.)
